...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(Context context, Rect anchorRect, View anchorView) {
        ...
        if (access$5002 == 8388659 || access$5002 == 8388691) {
            ...
            this.badgeCenterX = ViewCompat.getLayoutDirection(anchorView) == 0 ? ((((float) anchorRect.right) + this.halfBadgeWidth) - ((float) inset)) - ((float) totalHorizontalOffset) : (((float) anchorRect.left) - this.halfBadgeWidth) + ((float) inset) + ((float) totalHorizontalOffset);
        }
    }
